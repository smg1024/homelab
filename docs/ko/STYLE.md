...
`docs/ko/`의 한국어 문서를 새로 쓰거나 영어 문서와 맞출 때 적용하는
규약입니다. 맞춤법 교정보다 **문서 전체의 일관성**을 유지하는 데 목적이
있습니다.

문서 유형은 **기술 문서**입니다. 명령·경로·포트·코드블록·표 중심이며
...
도구·프로토콜·명령과 직결되는 용어는 **영문 표기**를 그대로 씁니다(음차
금지). 일반어는 한글로 통일합니다.
...
- 경고·필수 조건 강조 → **굵게**.
- 개념이나 직접 인용 문구 → 큰따옴표 `""`.
- 안내 상자는 admonition을 씁니다: `!!! note`, `!!! tip`, `!!! warning`,
  `!!! danger`.
